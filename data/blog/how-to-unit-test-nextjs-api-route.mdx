...
2. Create a [setup file for vitest](https://github.com/nicnocquee/nico.fyi/main/__tests__/setup.ts). In this file I instantiate the MSW node server which will intercept all requests made within the API route handler.
3. Create a test for the API route in [the route.test.ts file](<https://github.com/nicnocquee/nico.fyi/main/app/(other-pages)/should-you-use-vercel/api/route.test.ts>).
...
4. If you use the [module path aliases](https://nextjs.org/docs/app/building-your-application/configuring/absolute-imports-and-module-aliases) in your test file, as I did [here](<https://github.com/nicnocquee/nico.fyi/main/app/(other-pages)/should-you-use-vercel/api/route.test.ts>), you need to add them to the [vitest config file](https://github.com/nicnocquee/nico.fyi/main/vite.config.ts):
...
1. [vitest.config.ts](https://github.com/nicnocquee/nico.fyi/main/vite.config.ts)
2. [setup.ts](https://github.com/nicnocquee/nico.fyi/main/__tests__/setup.ts)
3. [route.test.ts](<https://github.com/nicnocquee/nico.fyi/main/app/(other-pages)/should-you-use-vercel/api/route.test.ts>)
4. [.env.test](https://github.com/nicnocquee/nico.fyi/main/.env.test)
