    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className="max-w-lg">
        <Alert>
          ...
          app/(experiments)/experiments/suspense-demo/with-template/guest/[id]/page.tsx. I don't
          ...
          app/(experiments)/experiments/suspense-demo/with-template/admin/[id]/page.tsx, is not the
          same as the component that renders this page.
          <br />
          <br />
