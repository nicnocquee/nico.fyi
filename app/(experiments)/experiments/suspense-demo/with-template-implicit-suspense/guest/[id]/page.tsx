  ...
  return (
    <div className="flex flex-col space-y-2">
      <div className="flex flex-col space-y-2 bg-slate-100 p-4 [&_a]:text-primary-500 [&_a]:underline">
        ...
        <div className="flex flex-row space-x-2">
          <div className="flex flex-row space-x-2">
            <Link
              prefetch={false}
              href="/experiments/suspense-demo/with-template-implicit-suspense/"
            >
              Root
            </Link>
            <Link
              prefetch={false}
              href={`/experiments/suspense-demo/with-template-implicit-suspense/admin/${nextRandomId}`}
            >
              Next admin page
            </Link>
            <Link
              prefetch={false}
              href={`/experiments/suspense-demo/with-template-implicit-suspense/guest/${nextRandomId}`}
            >
              Next guest page
            </Link>
            <Link
              prefetch={false}
              href={`/experiments/suspense-demo/with-template-implicit-suspense/${role}/${nextRandomId}`}
            >
              Next random page
            </Link>
          </div>
      ...
      <div className="max-w-lg">
        <Alert>
          Notice that when you click "Next guest page", the client time in template above{' '}
          ...
          <br />
          <br />
          Meanwhile, if you click on the "Next admin page", the client time in template above{' '}
          ...
          <b>admin page</b>, the text that you typed will be lost because the search field component
